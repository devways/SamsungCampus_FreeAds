    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Add Annonce</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('annonce/edit/'.$id) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" class="form-control" name="price" value="{{ $annonce->price }}">
